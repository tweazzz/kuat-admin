...
urlpatterns = [
    ...
    path("api/partners-section/", PartnersSectionView.as_view(), name="partners-section"),
    path("api/partners/", PartnerView.as_view(), name="partners"),
    path("api/partners/<int:pk>/", PartnerDetailView.as_view(), name="partner-detail"),
